...
function CreadMsg(user, content) {
    var str = "";
    if(user == 'default') {
        str = "<div class=\"msg guest\"><div class=\"msg-right\" worker=\"\"><div class=\"msg-host photo\" style=\"background-image: url('PIC/icon.png');\"></div><div class=\"msg-ball\" >" + content +"</div></div></div>"
    } else if(user == 'system') {
        str = '<div class="pnl-list" style="text-align: center;color: grey;">'+content+'</div>'
    } else {
        str = "<div class=\"msg robot\"><div class=\"msg-left\" worker=\""+user+"\"><div class=\"msg-host photo\" style=\"background-image: url('PIC/icon.png');\"></div><div class=\"msg-ball\">" + content + "</div></div></div>";
    }
    return str;
}
